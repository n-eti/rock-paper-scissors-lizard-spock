...
''')
    ...
    #  while self.player1.score < 2 and self.player2.score < 2:
        if self.player1.selected_gesture == self.player2.selected_gesture:
                print("It's a tie!")
        elif self.player1.selected_gesture == "1":
